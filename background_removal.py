...
# أقصى بُعد للصورة قبل معالجتها بالذكاء الاصطناعي. تم تخفيضه من 1600 إلى
# 1100 بكسل لأن استهلاك الذاكرة في نماذج الذكاء الاصطناعي يتناسب تقريباً
# مع (العرض × الارتفاع)، فتخفيض البُعد الأقصى بمقدار الثلث يقلل استهلاك
# الذاكرة الفعلي بنسبة أكبر بكثير من الثلث. لا يزال هذا كافياً جداً لجودة
# ممتازة في البوستر النهائي (أقصى حجم يُستخدم فعلياً هناك ~750 بكسل).
# يمكن تعديل القيمة مباشرة من متغيرات البيئة في Railway باسم
# MAX_IMAGE_DIMENSION بدون الحاجة لتعديل الكود مطلقاً.
